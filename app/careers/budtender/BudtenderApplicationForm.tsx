...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Fort York" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="FYC01" />
      <input type="hidden" name="StoreName" value="FORT YORK CANNABIS" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at FORT YORK CANNABIS?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Fort York Boulevard for scheduled shifts?</legend>
