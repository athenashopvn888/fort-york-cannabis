        ...
        <div className={styles.container}>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.sectionBody}>
              The site is prepared for common cannabis retail categories, but exact inventory, pricing, brands, pickup, delivery, and availability remain PENDING_OWNER_INPUT.
            </p>
            <div className={styles.categoryGrid}>
              {MENU_CATEGORIES.map((category) => (
                <Link key={category} href="/#menu-status" className={styles.categoryCard}>
                  <span className={styles.categoryLabel}>{category}</span>
                  <span className={styles.categoryStatus}>PENDING_OWNER_INPUT</span>
                </Link>
              ))}
            </div>
          </div>
