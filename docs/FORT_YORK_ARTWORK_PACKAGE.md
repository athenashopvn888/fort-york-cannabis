...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Primary logo | `public/brand/fort-york-logo.png` | 1024x1024 | PNG | Header, age gate, favicon source | FYC monogram, dark base, copper border, teal accent | FYC, Fort York Cannabis | Phone, hours, license, reviews | Final owner brand approval | Current concept exists |
