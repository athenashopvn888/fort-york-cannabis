...
Local-only first-pass storefront scaffold for `fortyorkcannabis.com`.
...
This local scaffold does not deploy, push, touch GBP, touch WordPress, touch Google Sheets, touch Apps Script, or call live services.
